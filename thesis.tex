...
%|                    Infos about thesis                         |
% ---------------------------------------------------------------
\newcommand{\myname}{Kalle der Wilde}
\newcommand{\mytitle}{Komm in die WhatsApp Gruppe und werde Reich!}

\newcommand{\reviewerone}{Prof. Dr. Dr.-Ing. Sebastian Vettel}
\newcommand{\advisor}{Präsident Donald Trump}

\newcommand{\timeandplace}{Karlsruhe, Oktober 2020}
...
\hypersetup{
 ...
 pdftitle={\mytitle},
 pdfsubject={Thesis},
 pdfkeywords={Donald, Wild, rigged2020}
}
...
\ifuseglossaries
	...
	% ordinary acronyms
	\include{Glosseries/Acronyms} 
	
	% symbols	
	\include{Glosseries/Symbols} 	
	
	% online referenzes
	\include{Glosseries/OnlineRef} 
\else
\fi
...
\include{Main/3_System}
\include{Main/4_Modelle}
